...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        vegetarianPizza.add("Pizza dough", "250 g");
        vegetarianPizza.add("Tomato sauce", "1/3 cup");
        vegetarianPizza.add("Mozzarella cheese", "1/2 cup");
        vegetarianPizza.add("Mushrooms", "3/4 cup");
        vegetarianPizza.add("Black olives", "1/4 cup");
        vegetarianPizza.add("Olive oil", "1 tbsp");
        ArrayList <Ingredient> riceAndBeans = new ArrayList<>(); // veg, low carbs, beans
        riceAndBeans.add("rice", "210 g");
